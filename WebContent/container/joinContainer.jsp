							...
							<table>
								...
								<tr>
									...
									<td><input type="radio" name="gender" id="gender"
										...
										id="gender" value="여">여</td>
								</tr>

								<tr>
									<td><label for="hobbys">취미</label></td>
									<td><input type="checkbox" name="hobbys" id="hobbys"
										value="여행">여행 <input type="checkbox" name="hobbys"
										id="hobbys" value="독서">독서 <input type="checkbox"
										name="hobbys" id="hobbys" value="영화감상">영화감상 <input
										type="checkbox" name="hobbys" id="hobbys" value="낚시">낚시
										<input type="checkbox" name="hobbys" id="hobbys" value="등산">등산
										<input type="checkbox" name="hobbys" id="hobbys" value="기타">기타</td>
								</tr>
								...
								<tr>
									<td colspan="2"><textarea name="memo" id="memo" cols="30"
											rows="10" placeholder="자기소개 입력란">
									</textarea></td>
								</tr>

								<tr class="btnZone">
									<td id="btn" colspan="2"><input type="submit" value="생성"
